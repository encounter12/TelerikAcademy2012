...
namespace MultidimensionalArrays
{
    ...
    {        
        ...
        static int[,] FillMatrixUpsideDownWithSequentialNumbers(int n)
        {
        ...
        static int[,] FillMatrixVerticalCrossSideWithSequentialNumbers(int n)
        {
            int[,] matrix = new int[n, n];
            int counter = 1;
            for (int j = 0; j < n; j++)
        ...
        static int[,] FillMatrixDiagonallyWithSequentialNumbers(int n)
        {
            int[,] matrix = new int[n, n];
            int elementValue = 1;
        ...
        static int[,] GenerateSpiralMatrix(int rows, int columns)
        {
